...
public class L1Assignment {
     ...
     * Example: Given a list of integers, calculate the sum of all numbers.
     ...
     * Output: 20
     * Explanation: 20 is the largest number in the list.
     */
     ...
     * Output: [2, 4, 6, 8]
     * Explanation: Only numbers divisible by 2 are returned.
     */
     ...
     * Output: [1, 2, 3, 4, 5]
     * Explanation: distinct() removes duplicate elements keeping only unique values.
     */
     ...
     * Example: Given a list of integers, skip the first 3 elements and return the rest.
     * Example: Numbers: [1, 2, 3, 4, 5, 6, 7, 8]
     * Output: [4, 5, 6, 7, 8]
     * Explanation: skip(3) skips the first 3 elements and returns remaining elements.
     */
     ...
     * Explanation: Collectors.joining() concatenates all strings with the specified delimiter.
     */
     ...
     * Example: Nested Lists: [[1, 2], [3, 4], [5, 6, 7]]
     ...
     * Output: 30.0
     * Explanation: (10 + 20 + 30 + 40 + 50) / 5 = 30.0
     */
     ...
     * Explanation: partitioningBy() groups numbers by the predicate (even = true, odd = false).
     */
     ...
     * Example: Numbers: [10, 5, 20, 8, 15, 3]
     * Output: 5
     ...
     * Explanation: Each string is mapped to its length using toMap() collector.
     */
     ...
     * Output: [10, 20, 30]
     * Explanation: limit(3) restricts the stream to first 3 elements.
     */
     ...
     * Output: true
     * Explanation: anyMatch() returns true if at least one element matches the condition.
     */
     ...
     * Explanation: groupingBy() groups strings based on their first character.
     */
     ...
     * Example: Given a list of employees, filter all employees from the "IT" department.
     * Example: Employees:
     * [
