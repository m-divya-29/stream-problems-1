...
List<Employee> employees = List.of(
    ...
    public void testTopNFrequentElements() {
        List<String> input = List.of("apple", "banana", "apple", "orange", "banana", "apple", "kiwi", "kiwi", "kiwi", "kiwi", "banana", "banana", "banana", "pineapple", "pineapple", "pineapple", "pineapple", "pineapple", "pineapple", "grape", "grape", "grape", "grape", "grape", "grape", "grape");
        int n = 2;
...
List<Employee> employees = List.of(
        ...
        new Employee("Charlie", "HR", 70000.0),
        new Employee("David", "IT", 90000.0),
        new Employee("Eve", "IT", 85000.0),
        new Employee("Frank", "Finance", 75000.0),
        new Employee("Grace", "Finance", 70000.0),
        new Employee("Heidi", "Finance", 80000.0),
        new Employee("Ivan", "IT", 95000.0),
        new Employee("Judy", "HR", 65000.0),
        new Employee("Mallory", "IT", 92000.0),
        new Employee("Niaj", "Finance", 78000.0),
        new Employee("Olivia", "HR", 72000.0),
        new Employee("Peggy", "IT", 88000.0),
        new Employee("Sybil", "Finance", 77000.0),
        new Employee("Trent", "HR", 68000.0),
