...
public class L4AssignmentTest {
    ...
    public void testMultiLevelGroupingWithAggregation() {
        ...
        var expected = Map.of(
                "HR", Map.of("<70000", 1L, "70000-80000", 1L, ">80000", 0L),
                "IT", Map.of("<70000", 0L, "70000-80000", 2L, ">80000", 1L),
                "Finance", Map.of("<70000", 0L, "70000-80000", 1L, ">80000", 0L)
        );
        assertEquals(result, expected);
    }
    ...
    public void testCustomPartitioningWithPredicateChain() {
        ...
        Map<String, List<Employee>> expected = Map.of(
                "HIGH", List.of(new Employee("David", "IT", 90000.0), new Employee("Bob", "IT", 80000.0)),
                "MID", List.of(new Employee("Charlie", "HR", 70000.0)),
                "LOW", List.of(new Employee("Alice", "HR", 60000.0), new Employee("Eve", "Finance", 50000.0))
        );
        assertEquals(result, expected);
    }
    ...
    public void testCalculateSalaryStandardDeviationByDepartment() {
        List<Employee> employees = List.of(
                ...
                new Employee("Bob", "IT", 85000.0),
                new Employee("Charlie", "IT", 95000.0),
                new Employee("David", "HR", 60000.0),
